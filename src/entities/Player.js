...
export default class Player extends Tank {
  ...
  update() {
    ...
    if (this.isAlive) {
      ...
      // if (!checkVelocityZero && this.pNum == 'p1') {
      //   this.play('move_blue', true)
      // } else { this.play('move_blue', false) }

      // if (!checkVelocityZero && this.pNum == 'p2') {
      //   this.play('move_red', true)
      // } else { this.play('move_red', false) }

      // if (!checkVelocityZero && this.pNum == 'p3') {
      //   this.play('move_green', true)
      // } else { this.play('move_green', false) }

      // if (!checkVelocityZero && this.pNum == 'p4') {
      //   this.play('move_yellow', true)
      // } else { this.play('move_yellow', false) }
